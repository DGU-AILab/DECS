...
| --- | --- | --- | --- | --- | --- |
| `cuda11.8-tf2.13-ubuntu22.04-260618` | 11.8 | 2.13.0 | `nvidia/cuda:11.8.0-cudnn8-devel-ubuntu22.04` | 520.61.05 | stable |
| `cuda12.2-tf2.15-ubuntu22.04-260618` | 12.2 | 2.15.0 | `nvidia/cuda:12.2.2-cudnn8-devel-ubuntu22.04` | 535.104.05 | stable |
| `cuda12.5-tf2.20-ubuntu22.04-260618` | 12.5 | 2.20.0 | `nvidia/cuda:12.5.1-cudnn-devel-ubuntu22.04` | 555.42.06 | stable |
| `cuda12.8-tf2.20-ubuntu22.04-260618` | 12.8 | 2.20.0 | `nvidia/cuda:12.8.1-cudnn-devel-ubuntu22.04` | 570.124.06 | experimental |
...
bash ~/uid/script/create_container.sh \
  --image decs \
  --version cuda12.5-tf2.20-ubuntu22.04-260618
```
...
```bash
tar -czf /tmp/decs-build-context-260618.tgz Dockerfile entrypoint.sh .dockerignore

ansible-playbook \
  -i /home/jy/ansible/inventory.ini \
  tests/ansible/decs_image_build.yml \
  -e target_hosts=lab10 \
  -e image_tag=cuda12.8-tf2.20-ubuntu22.04-260618 \
...
ansible-playbook \
  ...
  tests/ansible/decs_image_smoke.yml \
  -e target_hosts=lab10 \
  -e image_tag=cuda12.5-tf2.20-ubuntu22.04-260618 \
  -e enable_vnc=true
```
