...
| :--- | :--- | :--- | :--- | :--- |
| `dguailab/decs:latest`<br>`dguailab/decs:260505` | **2.18.0** | CUDA 12.5<br>cuDNN 8.9 | Ubuntu 22.04 | **(최신, 문제 있음)** `/etc/passwd`, `/etc/group`를 컨테이너에 마운트해야 동작합니다. 이 경우 호스트와 계정 정보를 공유하게 되어 컨테이너의 주인이 아닌 다른 유저가 컨테이너에 접속할 수 있는 문제가 발생할 수 있습니다. |
